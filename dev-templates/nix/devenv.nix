...
in {
  ...
  enterShell = ''
    ...
    alias fcheck='cd "$REPO_ROOT" && nix-fast-build       .#nixosConfigurations.centauri.config.system.build.toplevel       .#nixosConfigurations.mirach.config.system.build.toplevel       .#nixosConfigurations.albaldah.config.system.build.toplevel       .#homeConfigurations."djoolz@workstation".activationPackage'
