...
```shell
nix flake init --template path:/home/djoolz/Documents/01_config/mine#${ENV}
```
...
nix flake init --template path:/home/djoolz/Documents/01_config/mine#rust

# Create a new project
nix flake new --template path:/home/djoolz/Documents/01_config/mine#rust ${NEW_PROJECT_DIRECTORY}
```

From the repo root, the shorter form also works:

```shell
nix flake new --template .#rust ${NEW_PROJECT_DIRECTORY}
```
...
- [Python]
- [uv] (default package and virtual environment workflow, using `~/.cache/uv`)
- [ruff]
- [basedpyright]
- [mypy]
- [pytest]
